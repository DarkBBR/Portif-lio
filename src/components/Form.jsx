...
const Form = () => {
    ...
    const formSubmitHandler = (e) => {
        ...
        send(
            "service_w0cd69c", // Service ID
            "template_4wj55em", // Template ID
            userInput,
            "diKxEU40BF86z4RFW" // Public Key - https://dashboard.emailjs.com/admin/account
        )
            .then((response) => {
    ...
    const formSuccess = () => {
        toast(
            "Obrigado por enviar sua consulta, voltarei a você em breve."
        );
            ...
            >
                ...
                <div className="flex flex-col gap-2">
                    <label
                        ...
                        className="text-[16px] text-black uppercase"
                    >
                        Por Favor, Fale um pouco sobre você e o seu projeto
                        <sup>*</sup>
                    </label>
                    <textarea
                        name="message"
                ...
                <button className="bg-[#111111] h-[64px] max-w-[585px] text-[16px] transition-transform active:scale-[0.95]">
                    Eviar mensagem para o e-mail de BDarkBR?
                </button>
                {/* SUBMIT BUTTON */}
            </form>
        </Div>
