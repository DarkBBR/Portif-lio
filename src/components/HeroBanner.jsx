  ...
  return (
    ...
    >
      ...
      <Wrapper>
        ...
        >
          <h1 className="text-[50px] md:text-[50px] 2xl:text-[189px] leading-[50px] md:leading-[125px]  2xl:leading-[192px] font-oswald uppercase">
            Olá Dev
        ...
        >
          <div className="font-light mb-4">
            ...
            <span className="font-semibold">
              Arthur mas sou mais conhecido como BDarkBR
            </span>
          </div>
          <div className="max-w-[510px]">
            Eu sou programador a 4 anos e trabalho com Front-End e Back-End,
            crio projetos em ReactJS e NextJs, também crio bots para whatsapp e
            WebSites sendo assim, sou{" "}
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <div className="text-[80px] font-light">22+</div>
            <div className="leading-[22px]">Projetos</div>
          </div>
          {/* END */}
        ...
        >
          ...
          >
            ...
            <a href="https://github.com/DarkBBR">
              <div className="text-black">Meu GitHub</div>
            </a>
          </div>
          {/* HIRE ME BUTTON END */}
        </motion.div>
