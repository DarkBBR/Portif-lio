        ...
        <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
          ...
          <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
            <Service
              num="1"
              title="Ui/Ux Design"
              desc="Melhor Design de sites feitos com NextJs ou ReactJs."
              data={["Sites", "Modernos", "Designs"]}
            />
            <Service
              num="2"
              title="Automatização"
              desc="Sites como E-commerces que usam Checkout Avançado com Api-PIX."
              data={["API", "PIX", "Qr-Code"]}
            />
            <Service
              num="3"
              title="Front-End e Back-End"
              desc="Melhor Adaptação com a linguagem de Hipertexto HTML e de estilização CSS, junto com automatizações e adaptações JavaScript juntando, temos uma livraria do JS o ReactJS."
              data={[
                "HTML",
                "CSS",
                "JS",
